...
///
std::shared_ptr<Simulator> SimulatorBuilder::Build(const std::string& config_file_name,
...
/// Build the simulator.
std::shared_ptr<Simulator> SimulatorBuilder::Build(const boost::property_tree::ptree& pt_config,
		const boost::property_tree::ptree& pt_disease, const boost::property_tree::ptree& pt_contact,
		unsigned int num_threads, bool track_index_case)
{
