...
shared_ptr<Simulator> SimulatorBuilder::Build(const string& config_file_name, unsigned int num_threads,
...
shared_ptr<Simulator> SimulatorBuilder::Build(const ptree& pt_config, unsigned int num_threads, bool track_index_case)
{
	// Disease file.
	ptree pt_disease;
...
shared_ptr<Simulator> SimulatorBuilder::Build(const ptree& pt_config, const ptree& pt_disease, const ptree& pt_contact,
